...
печная труба. Над провалившейся кровлей огонь идёт столбом, дым снизу подсвечен пламенем.
Догоревший дом ещё 1–2 минуты тлеет: дымок, искры, язычки в углях, на полу обугленные балки.
Стены режутся на секции ~1.3 м в два яруса, поэтому взрыв пробивает дыру, а не сносит всю
стену. Верхний ярус без опоры падает. Угловые и лобовые доски, ставни, отлив держатся на
своих кусках. Трубу над кровлей можно сбить прямым попаданием. Огонь перекидывается на траву и соседние дома, дождь его сбивает. В горящем
доме можно сгореть. Выстрел по двери или доске копит урон.

## Высота, переправы, подземелья

- **Пожарные вышки** (пара, западный и восточный край): решётчатая ферма 24 м, внутри шесть
  маршей лестниц с площадками-решётками. Лезешь снизу, наверху шагаешь к следующему маршу. В
  будке наблюдателя стёкла, стол с картой ориентиров, пеленгатор, записка с позывными. Ночью на
  крыше мигает красный огонь. Нижние 4 м каждой ноги — отдельные детали: подорвали одну, и
  ферма валится в сторону выбитой ноги и ложится поперёк леса препятствием.
- **Водокачки** (башня Рожновского) у лагеря и у турбазы: лестница снаружи со страховочной
  клеткой, кольцевая площадка с перилами. Пробитый бак течёт струями. Если подорвать цоколь,
  башня падает целиком.
- **Охотничьи лабазы** по углам: помост на 4 м с амбразурой и лапником, стремянка с тыла.
  Подрубили жердь — помост падает.
- **Лестницы:** W — лезть вверх, S — вниз, Space — спрыгнуть. Если шагнуть в люк или с края
  площадки, игрок сам хватается за лестницу.
- **Мост на остров:** свайный, от берега у Alpha через остров к берегу у Delta. Каждый пролёт —
  отдельная деталь: после взрыва пролёт падает в воду и плывёт.
- **Броды** у концов озера: песчаная коса по колено, по ней камни и вешки. Рядом лодки на
  привязи: качаются, их сносит ветром и взрывом, игрок может их толкать.
- **Ручей в овраге** (пара): течёт из леса за минным полем в озеро. Вдоль берегов валы, вода
  течёт, на перекатах пена. На тропе кладка, ниже бревно-переход. Под кольцевой бетонная труба:
  пролезть можно только пригнувшись (C). В ручье ноги мокнут, ход медленнее.
- **Болото** (пара): окна тёмной воды, осока на кочках, рогоз, сухие берёзы. По болоту ход вдвое
  медленнее и хлюпает. Поперёк лежит гать, по ней идти быстро.
- **Погреб** под столовой лагеря и **подвал-штаб** под корпусом турбазы: люк в полу, лестница
  вниз, тусклая лампочка. Внутри полки, бочки. В штабе нары, стол с рацией, карта, позывные на
  стене. Дом может сгореть, а подвал останется.
- **Перекрытая щель:** середина хода сообщения у каждой базы накрыта накатом и землёй.

## Интерактив

- **Двери** на петлях: E — открыть или закрыть, со скрипом. Закрытая дверь держит проход и пулю,
  взрыв её вышибает.
- **Колючка** перед окопами: держать E у нити — перекусить (1.3 с). Взрыв рвёт её сам.
- **Генератор базы** питает прожекторы и фонари. Если его подорвать или расстрелять, свет на базе
  гаснет вразнобой, генератор горит.
- **Фонари и прожекторы** бьются пулей.
- **Мешки с песком** от попаданий мнутся и оседают, сыплется песок, укрытие становится ниже.
  Близкий разрыв сносит мешки.
- **Пробоины** остаются на стенах, машинах и стволах и пропадают вместе с разрушенной деталью.
  На части домов с самого начала следы очередей.
- **Вороны** сидят стаями на высоких соснах. Выстрел, разрыв, дрон вплотную или боец, который
  ломится через кусты не пригнувшись, поднимают стаю: карканье, птицы кружат и улетают на
  другое дерево. Этим можно выдать себя или заметить чужого.

## Следы фронта

- **Ми-8** упал в лес на западном краю: фюзеляж на боку, хвостовая балка оторвана, лопасти
  согнуты, вокруг сломанные деревья и гарь, обломки ещё тлеют.
- **Позиция Д-30** напротив, у Delta: мешки, ящики, открытые со снарядами, гора гильз,
  сползшая маскировочная сеть, таблица стрельбы.
- **Пулемётные гнёзда** (пара): ПКМ на бруствере, цинки, каска, веер гильз, записка под камнем.
- **Сгоревшая БМП-2** на дороге турбазы (гусеница соскочила, кормовые двери открыты) и **Т-72**
  у лагеря (башню сорвало, лежит вверх дном с погнутым стволом).
- **Старый огневой вал:** цепочка заплывших воронок поперёк луга.
- **Записки:** позывные, частоты, пароль и отзыв, ориентиры, схема. Лежат в блиндажах,
  погребах, на вышке, в гнёздах, у вертолёта.

## Облик

- Кровля выцвела и посерела, по желобкам тянутся потёки, у свеса мох и лишайник. Ржавчина
  приглушена: крыши больше не «кирпичные».
- Трава приглушённее, на открытых местах пятна выгоревшей травы.
- Пни с корой, мхом у земли, годовыми кольцами на спиле или расщеплённым обломом, корнями и
  трутовиками.

## Оптимизация и пресеты

Все пресеты показывают одну и ту же карту и одни и те же укрытия (деревья, подрост, кусты,
стены). Пресеты меняют только бюджеты.

| | минимальное | низкое | среднее | высокое |
|---|---|---|---|---|
| Рендер / тени | ×0.75, 512, раз в 3 кадра | ×1, 1024, раз в 2 | ×1.25, 2048 | ×1.6, 4096 |
| Мягкие тени, блум, SMAA | нет | нет | да | да |
| Фонари со светом / с тенью | 1 / 0 | 2 / 0 | 4 / 1 | 6 / 2 |
| Тела физики, шаг | 45, 1/40 с | 80, 1/50 с | 130, 1/60 с | 180, 1/60 с |
| Частицы (пул, доля) | 360, 50 % крупнее | 480, 70 % | 640, 85 % | 800, 100 % |
| Мелкая растительность до | 30 м | 55 м | 75 м | 95 м |

- **Физика.** Спящие тела не читаются и не синхронизируются. Число тел и обломков на один
  взрыв задаётся пресетом. На слабых пресетах шаг крупнее и подшагов меньше.
- **Частицы.** На слабых пресетах частиц меньше, но каждая крупнее, поэтому плотность огня и
  дыма остаётся той же. Пул кольцевой, без сдвигов массива. В GPU уходит только живая часть.
- **Подлесок.** Разбит на квадраты по 64 м с отсечением по пирамиде видимости. Мелочь
  (цветы, иван-чай, бурьян, черничник) гаснет за дальностью пресета. Укрытия видны всегда.
- **Трава.** Плотность полога и травы берётся из кэша. Раньше при движении камеры шёл
  аналитический шум на каждую травинку, отсюда были рывки по 30–55 мс.
- **Ткань.** Флаги и сети дальше порога не считаются, вне кадра считаются в 8 раз реже.
- **Свет.** Пул фонарей без выделения памяти за кадр. Карта тени фонаря перерисовывается,
  только пока он горит.
- **Автоподстройка.** Если кадр дольше ~36 мс, сначала снижается разрешение. Если и на
  минимуме тяжело, тени обновляются реже, отключается блум, трава редеет. При запасе всё
  возвращается в обратном порядке.
...
Вблизи — геометрические травинки (изогнутые ленты, тёмные у корня, сухие кончики, у части —
колоски), дальше — карточки. Кроме папоротника, черничника и подроста ёлок есть кусты ивняка
и лещины (на опушках и у воды, это укрытие от взгляда), иван-чай на прогалинах и минной
полосе, луговые цветы (ромашка, колокольчик, клевер, пижма), сухой бурьян с метёлками. Приминается игроком, качается ветром и ударной волной, оседает и чернеет в гари,
